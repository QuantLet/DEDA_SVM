...
ax.plot(fpr_log, tpr_log, linewidth=2)

ax.set_xlabel("False Positive Rate")
ax.set_ylabel("True Positive Rate")

ax.set_title(
    f"Logistic ROC (AUC = {roc_auc_score(y_test, pre_log):.3f})"
)
...
ax.set_title(
    f"SVM ROC (AUC = {roc_auc_score(y_test, pre_svm):.3f})"
)
